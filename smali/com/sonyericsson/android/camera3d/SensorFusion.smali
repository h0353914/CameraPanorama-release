...
.method public constructor <init>(Z)V
    ...
    .line 79
    invoke-virtual {p1}, Lcom/sonyericsson/android/camera3d/core/MorphoSensorFusion;->initialize()I
    ...
    const-string v0, "MorphoSensorFusion.initialize error ret:0x%08X"
...
.method private calcRotationMatrix([DDDD)V
    ...
    .line 385
    invoke-direct {p0, v4, v1, v2}, Lcom/sonyericsson/android/camera3d/SensorFusion;->multMatrix([D[D[D)V

    move-object v1, p1

    .line 386
    invoke-direct {p0, p1, v4, v3}, Lcom/sonyericsson/android/camera3d/SensorFusion;->multMatrix([D[D[D)V
...
.method private updateSensorMatrix()I
    ...
    const-string v8, "SensorFusion.setSensorData(SENSOR_TYPE_GYROSCOPE) error ret:0x%08X"
    ...
    const-string v8, "SensorFusion.setSensorData(SENSOR_TYPE_ACCELEROMETER) error ret:0x%08X"
    ...
    const-string v8, "SensorFusion.setSensorData(SENSOR_TYPE_MAGNETIC_FIELD) error ret:0x%08X"
    ...
    const-string v8, "SensorFusion.setSensorData(SENSOR_TYPE_ROTATION_VECTOR) error ret:0x%08X"
