...
.method public constructor <init>(IIIFLjava/lang/String;)V
    ...
    const-string p1, "MORPHO"

    const-string p2, "VideoRecorder enter"
    ...
    .line 35
    sget-object p5, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    sget-object v0, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    sget-object v1, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    invoke-static {p2, p5, v0, v1}, Landroid/opengl/EGL14;->eglMakeCurrent(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;Landroid/opengl/EGLSurface;Landroid/opengl/EGLContext;)Z

    .line 38
    new-instance p5, Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder$CodecInputSurface;

    iget-object v0, p0, Lcom/sonyericsson/android/camera3d/utils/VideoRec/BaseVideoRecorder;->mSurface:Landroid/view/Surface;

    invoke-direct {p5, v0, p1}, Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder$CodecInputSurface;-><init>(Landroid/view/Surface;Landroid/opengl/EGLContext;)V

    iput-object p5, p0, Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder;->mInputSurface:Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder$CodecInputSurface;

    .line 40
    iget-object p5, p0, Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder;->mInputSurface:Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder$CodecInputSurface;

    invoke-virtual {p5}, Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder$CodecInputSurface;->makeCurrent()V

    .line 41
    new-instance p5, Lcom/sonyericsson/android/camera3d/utils/render/ShaderHelper;

    invoke-direct {p5}, Lcom/sonyericsson/android/camera3d/utils/render/ShaderHelper;-><init>()V

    iput-object p5, p0, Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder;->mShader:Lcom/sonyericsson/android/camera3d/utils/render/ShaderHelper;

    .line 42
    iget-object p5, p0, Lcom/sonyericsson/android/camera3d/utils/VideoRec/VideoRecorder;->mShader:Lcom/sonyericsson/android/camera3d/utils/render/ShaderHelper;

    const/4 v0, 0x0

    invoke-virtual {p5, v0}, Lcom/sonyericsson/android/camera3d/utils/render/ShaderHelper;->initShader(I)V
    ...
    .line 45
    invoke-static {p2, p4, p3, p1}, Landroid/opengl/EGL14;->eglMakeCurrent(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;Landroid/opengl/EGLSurface;Landroid/opengl/EGLContext;)Z

    const-string p0, "MORPHO"

    const-string p1, "VideoRecorder exit"
...
.method public end()V
    ...
    const-string v5, "end process start..."

    .line 76
    invoke-static {v4, v5}, Lcom/sonyericsson/android/camera3d/utils/LogFilter;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "record ended!!!!"

    .line 84
    invoke-static {p0, v4}, Lcom/sonyericsson/android/camera3d/utils/LogFilter;->d(Ljava/lang/String;Ljava/lang/String;)V
